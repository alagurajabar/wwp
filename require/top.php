...
<head>
    ...
    <link rel="shortcut icon" href="assets/wwplogo.png" type="image/x-icon" />
    <title>Document</title>
    <script src="assets/js/jquery.js"></script>
    <script src="assets/js/sweetalert.js"></script>
    <style>
        <?php
            // Inline all required CSS so the page can be served without separate CSS files
            echo file_get_contents(__DIR__ . '/../assets/css/style.css');
            echo "\n";
            echo file_get_contents(__DIR__ . '/../assets/css/owl.carousel.min.css');
            echo "\n";
            echo file_get_contents(__DIR__ . '/../assets/css/owl.theme.default.min.css');
        ?>

        /* Responsive overrides for the home page */
    ...
    <header class="header">
        <div class="top-header">
            <div class="th">
                <div class="logo">
                    <a href="index.php">
                        <img src="assets/wwplogo.png" alt="logo" />
                    </a>
                </div>
                <div class="name">
                    WWP <br />
